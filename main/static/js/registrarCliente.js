      ...
      .then((data) => {
        ...
        if (data.clientes) {
          ...
          data.clientes.forEach((cliente) => {
            ...
            console.log("Membresía del cliente:", membresia)
            ...
            console.log("Estado de la membresía:", estadoMembresia)
            ...
            console.log(`Cliente: ${cliente.nombre_cliente}, Estado: ${estadoMembresia}, Membresia: ${nombreMembresia}`)
