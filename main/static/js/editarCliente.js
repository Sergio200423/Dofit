document.addEventListener("DOMContentLoaded", () => {
  console.log("Script de edición de clientes cargado");
  ...
  window.closeModal = function() {
    ...
    cerrarBtn.addEventListener("click", () => {
        console.log("cerrarBtn clickeado");
        closeModal();
    });
} else {
...
if (closeModalBtn) {
    console.log("closeModalBtn encontrado:", closeModalBtn);
    closeModalBtn.addEventListener("click", () => {
        console.log("closeModalBtn clickeado");
        closeModal();
    });
} else {
...
window.asignarEventosEditar = function() {
  const botonesEditar = document.querySelectorAll(".btn.btn-link");
  console.log("[DEBUG] Cantidad de botones 'Editar' detectados:", botonesEditar.length);
  const form = document.getElementById("editarClienteForm");
  const alertMessage = document.getElementById("alert-message");
  botonesEditar.forEach((boton, index) => {
    boton.addEventListener("click", () => {
      console.log(`[DEBUG] Botón de editar clickeado: Botón #${index + 1}`);
