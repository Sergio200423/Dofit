...
from main.servicio.servicioClientes import validarEstudiante
...
def registrarPagoDescuentos(pago, descuento):
    ...
    if descuento.nombre.lower() == "estudiante":
        ...
        valido, mensaje = validarEstudiante(pago.cliente.estudiante)
        if not valido:
    ...
    membresia_activa = RepositorioMembresiaCliente.obtener_membresia_activa(pago.cliente.id_cliente)
