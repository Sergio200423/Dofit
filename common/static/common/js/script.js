...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (function () {
    try {
        ...
        /* Visitors chart */
        var ctx = document.getElementById('myChart'); // Verifica si el elemento existe
        ...
        if (ctx && typeof Chart !== 'undefined') {
            ...
            console.log("El gráfico 'myChart' no está presente en esta página.");
        }
    } catch (error) {
    ...
    //   var CCustomersChart = new Chart(customersChartCanvas, {
    //     type: 'line',
    //     data: {
    //       labels: ['Dec', 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
    //       datasets: [{
